...
export default class extends React.Component {
  ...
  render() {
    const { isLoading, temp, condition, winds, names } = this.state;
    return isLoading ? <Loading /> : <Weather temp={Math.round(temp)} condition={condition} winds={winds} names={names} />
  };
}
